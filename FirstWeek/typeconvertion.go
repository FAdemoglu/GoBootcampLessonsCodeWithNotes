...
func main() {
	//Go da tip dönüşümlerini iki şekilde yapabiliriz
	//İlk yöntem string(), int(),float64() gibi fonksiyonları kullanarak

	//string() fonksiyonu içn dikkat etmeniz gereken nokta 100 vb. karakterleri verdiğinizde sonucunda 100 değerini string tipinde almazsanız
