...
/**
Interface ler bir takım metot imzalarını (isimleri,parametreleri ve dönüş değerleri) barındıran taslak yapılardır

Go da bir interfacein bit struct ya da tip tarafından implemente edilmesinin tek yolu struct içerisindeki metotları birebir aynı isim,parametre ve dönüş değerleri ile yazmaktır
...
//Go da isimlendirilmiş bir tip başka bir tip ile aynı şeyleri içerse bile Go runtime'ı için bunlar iki farklı tip olarak değerlendirilir
