...
func main() {
	...
	//Go içerisinde yer alan new() fonksiyonu ise sizin struct'ınızı oluşturup içerisindeki tüm alanlara zero-value (varsayılan değer örn: integer için 0) atarak geriye bir pointer döner.
...
//Go 'da diğer dillerden farklı olarak bir constructor yapısı bulunmamakta
