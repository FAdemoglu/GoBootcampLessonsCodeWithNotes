...
func main() {
	...
	// aşağıdaki kod yukarıda anlatılan sebepten dolayı hata verecektir.

	m["my-key1"].Salary += 10

	// Map içerisinde bir key'in olup olmadığını kontrol etmek için aşağıdaki kod kullanılabilir.
